...
from articles.views import AddArticleView, EditArticleView,\
    ArticleApprovalView, ArticleStatusView, EditedArticlesView
...
urlpatterns = [
    ...
    path('articles-edited/',
         EditedArticlesView.as_view(), name='articles-edited'),
